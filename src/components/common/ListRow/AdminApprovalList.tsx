...
const AdminApprovalList = ({ onApproveSelect }: AdminApprovalListProps) => {
  ...
  const AdminApprovalListData = [
    { nickname: '유명한', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '박상민', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '박은지', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '주다현', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '남궁호수', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '우창욱', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '홍길동', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '홍길동', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '홍길동', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '홍길동', height: 60, infoMessage: '대기 중', isDarkMode: false },
    { nickname: '홍길동', height: 60, infoMessage: '대기 중', isDarkMode: false },
